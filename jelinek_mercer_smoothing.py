import os
from parse import parse_documents, parse_queries, load_documents
from bow_coll import BowColl
from bow_coll_queries import QueryCollection
"""
Pseudocode
1. Initialize:
...
def jelinek_mercer_smoothing(query, document, collection, lambda_=0.4):
    ...
    for word in query.terms:
        ...
        p_col = collection.get_word_freq(word) / collection.get_total_words()
